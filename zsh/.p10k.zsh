# Generated by Powerlevel10k configuration wizard on 2025-04-05 at 19:22 CEST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%183F'     # default foreground
      local      clean='%141F'   # green foreground
      local   modified='%177F'  # yellow foreground
      local  untracked='%147F'   # blue foreground
      local conflicted='%197F'  # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%96F'  # grey foreground
      local      clean='%96F'  # grey foreground
      local   modified='%96F'  # grey foreground
      local  untracked='%96F'  # grey foreground
      local conflicted='%96F'  # grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=97
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=183
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=182
  typeset -g POWERLEVEL9K_STATUS_OK_VISUAL_IDENTIFIER_EXPANSION='ok'

  # Status when some part of a pipe command fails but the overall exit status is zero. It may look
  # like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=182
